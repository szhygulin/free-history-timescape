...
\emph{dissolves} once the history shape is free.
...
catalog-forced). The pre-registered P3 outcome is PARTIAL, at $1.57\sigma$, and we
...
gravitational-wave standard sirens~\cite{GWTC3siren}---all sit in the low-to-mid
$70$s, far above the $\sim\!47$--$50\kmsmpc$ dressed rates that a self-consistent
in-model $\rd$ implies.
